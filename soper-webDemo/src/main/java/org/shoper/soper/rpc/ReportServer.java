...
public class ReportServer {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String recv_reportJobDone() throws TException
    {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class reportJobDone<I extends Iface> extends org.apache.thrift.ProcessFunction<I, reportJobDone_args> {
      ...
      public reportJobDone_result getResult(I iface, reportJobDone_args args) throws TException {
        reportJobDone_result result = new reportJobDone_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class reportJobDone<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, reportJobDone_args, String> {
      public reportJobDone() {
        super("reportJobDone");
      }
      ...
      public void start(I iface, reportJobDone_args args, AsyncMethodCallback<String> resultHandler) throws TException {
  ...
  public static class reportJobDone_result implements org.apache.thrift.TBase<reportJobDone_result, reportJobDone_result._Fields>, java.io.Serializable, Cloneable, Comparable<reportJobDone_result>   {
    ...
    public reportJobDone_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    private static class reportJobDone_resultStandardScheme extends StandardScheme<reportJobDone_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, reportJobDone_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reportJobDone_result struct) throws TException {
        struct.validate();
    ...
    private static class reportJobDone_resultTupleScheme extends TupleScheme<reportJobDone_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, reportJobDone_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, reportJobDone_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
